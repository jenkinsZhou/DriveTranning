 ...
 * @description :
 * @company :途酷科技
 * @date 2020年05月14日11:48
 * @Email: 971613168@qq.com
 */
public class NewsRecommendedMultipleAdapter extends BaseMultiItemQuickAdapter<NewsEntity, BaseViewHolder> {
    ...
    public NewsRecommendedMultipleAdapter(List<NewsEntity> data) {
        super(data);
