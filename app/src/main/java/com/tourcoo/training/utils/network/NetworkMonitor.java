package com.tourcoo.training.utils.network;
...
public class NetworkMonitor{
    ...
    int currentNetworkType = NetworkUtil.TYPE_UNKNOW;
    ...
    public NetworkMonitor(NetworkListener networkListener){
        ...
        task = new TimerTask() {
            @Override
            public void run() {
                int newType = NetworkUtil.getNetworkType();
                boolean newConnection = NetworkUtil.isNetworkConnected(true);
