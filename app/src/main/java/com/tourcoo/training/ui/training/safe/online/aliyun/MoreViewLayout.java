...
public class MoreViewLayout extends LinearLayout implements View.OnClickListener,RadioGroup.OnCheckedChangeListener {
    public MoreViewLayout(Context context) {
        super(context);
    }

    public MoreViewLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public MoreViewLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
    }

    public MoreViewLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public MoreViewLayout(AliYunPlayVideoActivity context, AliyunShowMoreValue moreValue) {
        super(context);
