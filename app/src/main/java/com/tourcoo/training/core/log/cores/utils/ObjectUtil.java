package com.tourcoo.training.core.log.cores.utils;
...
public class ObjectUtil {
    ...
    public static String objectToString(Object object, int childLevel) {
        ...
        List<IParser> parserList = ParserManager.getInstance().getParseList();
        if (parserList != null) {
    ...
    private static void getClassFields(Class cla, StringBuilder builder, Object o, boolean isSubClass,
        ...
        if (isSubClass) {
            builder.append(IParser.LINE_SEPARATOR).append(IParser.LINE_SEPARATOR).append("=> ");
        }
