...
import com.tourcoo.training.core.log.cores.parsers.LocalParserManager;
...
import static com.tourcoo.training.core.log.cores.LogLevel.TYPE_DEBUG;
import static com.tourcoo.training.core.log.cores.LogLevel.TYPE_ERROR;
import static com.tourcoo.training.core.log.cores.LogLevel.TYPE_INFO;
import static com.tourcoo.training.core.log.cores.LogLevel.TYPE_VERBOSE;
import static com.tourcoo.training.core.log.cores.LogLevel.TYPE_WARM;
import static com.tourcoo.training.core.log.cores.LogLevel.TYPE_WTF;
import static com.tourcoo.training.core.log.cores.utils.Utils.DIVIDER_BOTTOM;
import static com.tourcoo.training.core.log.cores.utils.Utils.DIVIDER_CENTER;
import static com.tourcoo.training.core.log.cores.utils.Utils.DIVIDER_NORMAL;
import static com.tourcoo.training.core.log.cores.utils.Utils.DIVIDER_TOP;
import static com.tourcoo.training.core.log.cores.utils.Utils.printDividingLine;
...
public class Logger implements IPrinter {
   ...
   public Logger() {
    ...
    private void logString(@LogLevel.LogLevelType int type, String msg, String tag, boolean isPart, Object... args) {
        ...
        if (mLogConfig.isShowBorder()) {
            if (isPart) {
                for (String sub : msg.split(IParser.LINE_SEPARATOR)) {
