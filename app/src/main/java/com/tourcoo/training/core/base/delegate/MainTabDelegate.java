...
public class MainTabDelegate {
     public static final String TAG = "MainTabDelegate";
    private Context mContext;
    private Object mObject;
    private FragmentManager mFragmentManager;
    private IMainView mIFastMainView;
    ...
    public MainTabDelegate(View rootView, FragmentActivity activity, IMainView iFastMainView) {
    ...
    public MainTabDelegate(View rootView, Fragment activity, IMainView iFastMainView) {
        if (iFastMainView == null || rootView == null || activity == null) {
            return;
        }
        ...
        if (mIFastMainView.isSwipeEnable()) {
            ...
            if (mObject instanceof FragmentActivity) {
                ...
                if (((Fragment) mObject).getActivity() != null) {
                    mTabLayout.setTabData(mTabEntities, Objects.requireNonNull(((Fragment) mObject).getActivity()), mIFastMainView.getContainerViewId(), fragments);
                }
                mTabLayout.setOnTabSelectListener(mIFastMainView);
            }
    ...
    private void getTabLayout(View rootView) {
        mTabLayout = rootView.findViewById(R.id.commonTabLayout);
        if (mTabLayout == null) {
    ...
    private void getViewPager(View rootView) {
        mViewPager = rootView.findViewById(R.id.vpContent);
        if (mViewPager == null) {
