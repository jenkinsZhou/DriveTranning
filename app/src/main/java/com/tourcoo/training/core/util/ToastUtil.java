...
public class ToastUtil {
    ...
    public static void show(int content, boolean isShowRunningForeground, Builder builder) {
        if (null == sContext) {
            throw new NullPointerException(FrameConstant.EXCEPTION_NOT_INIT);
        }
    ...
    private static void showToast(CharSequence content, boolean isShowRunningForeground, Builder builder) {
        ...
        if (!isShowRunningForeground || CommonUtil.isRunningForeground(sContext)) {
            sSystemToast.show();
        }
    }
    ...
    public static final class Builder {
        ...
        /**
         * 设置文本颜色{@link com.tourcoo.training.core.widget.view.radius.delegate.RadiusTextViewDelegate#setTextColor(int)}
         *
         * @param textColor
         * @return
         */
