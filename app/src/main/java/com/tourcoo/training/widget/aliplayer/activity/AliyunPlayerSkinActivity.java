...
import com.tourcoo.training.widget.aliplayer.playlist.AlivcPlayListManager;
import com.tourcoo.training.widget.aliplayer.playlist.AlivcVideoInfo;
...
import com.tourcoo.training.widget.aliplayer.utils.ToastUtils;
import com.tourcoo.training.widget.aliplayer.utils.VidStsUtil;
import com.tourcoo.training.widget.aliplayer.utils.database.DatabaseManager;
import com.tourcoo.training.widget.aliplayer.utils.database.LoadDbDatasListener;
...
import com.tourcoo.training.widget.aliplayer.view.download.DownloadChoiceDialog;
import com.tourcoo.training.widget.aliplayer.view.download.DownloadDataProvider;
import com.tourcoo.training.widget.aliplayer.view.download.DownloadView;
...
import com.tourcoo.training.widget.aliplayer.view.more.ShowMoreView;
 ...
 */
public class AliyunPlayerSkinActivity extends AliBaseActivity {
...
//                downloadView.changeDownloadEditState(false);
    ...
    private void showAddDownloadView(AliyunScreenMode screenMode) {
        ...
        if (currentPreparedMediaInfo != null && currentPreparedMediaInfo.get(0).getVid().equals(preparedVid)) {
            ...
            final View inflate = LayoutInflater.from(MyApplication.getContext()).inflate(
