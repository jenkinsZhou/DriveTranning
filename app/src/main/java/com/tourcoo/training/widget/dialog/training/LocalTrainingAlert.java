...
/**
 * @author :JenkinsZhou
 * @description :线下培训相关公用弹窗
 * @company :途酷科技
 * @date 2020年04月03日15:54
 * @Email: 971613168@qq.com
 */
public class LocalTrainingAlert {
    ...
    public LocalTrainingAlert(Context context) {
    ...
    public LocalTrainingAlert create() {
        // 获取Dialog布局
        View view = LayoutInflater.from(mContext).inflate(R.layout.alert_training_local_common, null);
        // 设置Dialog最小宽度为屏幕宽度
    ...
    public LocalTrainingAlert setPositiveButtonText(CharSequence text) {
    ...
    public LocalTrainingAlert setPositiveButtonClick(CharSequence text, View.OnClickListener onClickListener) {
        if (TextUtils.isEmpty(text)) {
            text = "";
        }
        if (tvAlertConfirm != null) {
