 ...
 * @description :
 * @company :途酷科技
 * @date 2020年04月22日11:03
 * @Email: 971613168@qq.com
 */
public class CommonWaringAlert {
    ...
    public CommonWaringAlert(Context context) {
    ...
    public CommonWaringAlert create() {
        // 获取Dialog布局
        View view = LayoutInflater.from(mContext).inflate(R.layout.alert_result_common, null);
        // 设置Dialog最小宽度为屏幕宽度
    ...
    public CommonWaringAlert setPositiveButtonText(CharSequence text) {
    ...
    public CommonWaringAlert setPositiveButtonClick(CharSequence text, View.OnClickListener onClickListener) {
        if (TextUtils.isEmpty(text)) {
            text = "";
        }
        if (tvAlertConfirm != null) {
    ...
    public CommonWaringAlert setTitleClick(CharSequence text, View.OnClickListener onClickListener) {
        if (TextUtils.isEmpty(text)) {
            text = "";
        }
        if (tvAlertTitle != null) {
    ...
    public CommonWaringAlert setContent(CharSequence text) {
        if (TextUtils.isEmpty(text)) {
            text = "";
        }
