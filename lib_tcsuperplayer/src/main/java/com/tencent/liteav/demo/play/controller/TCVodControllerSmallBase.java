...
public abstract class TCVodControllerSmallBase extends RelativeLayout implements TCPointSmallSeekBar.OnSeekBarChangeListener {
    ...
    protected TCPointSmallSeekBar mSeekBarProgress;
    ...
    public TCVodControllerSmallBase(Context context) {
        super(context);
        init();
    }

    public TCVodControllerSmallBase(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TCVodControllerSmallBase(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mGestureDetector = new GestureDetector(getContext(), new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onDoubleTap(MotionEvent e) {
                ...
                if (mHideViewRunnable != null) {
                    TCVodControllerSmallBase.this.getHandler().removeCallbacks(mHideViewRunnable);
                    TCVodControllerSmallBase.this.getHandler().postDelayed(mHideViewRunnable, 7000);
                }
                return true;
            }
            ...
            public boolean onDown(MotionEvent e) {
                ...
                if (mVideoGestureUtil != null) {
                    mVideoGestureUtil.reset(TCVodControllerSmallBase.this.getWidth(), mSeekBarProgress.getProgress());
                }
                return true;
            }
    ...
    @Override
    public void onProgressChanged(TCPointSmallSeekBar seekBar, int progress, boolean isFromUser) {
    ...
    @Override
    public void onStartTrackingTouch(TCPointSmallSeekBar seekBar) {
        this.getHandler().removeCallbacks(mHideViewRunnable);
    }

    @Override
    public void onStopTrackingTouch(TCPointSmallSeekBar seekBar) {
...
//        }
    ...
    private static class HideViewControllerViewRunnable implements Runnable {
        public WeakReference<TCVodControllerSmallBase> mWefControlBase;

        public HideViewControllerViewRunnable(TCVodControllerSmallBase base) {
